...
# stream-analytes-and-flows 2014-Jun-04 ()
#--------------------------------------------------------------
...
sourceID="dfwi-rpi-edu"               # Came from directory name ../../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetID="stream-analytes-and-flows"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetVersion="2014-Jun-04"        # DEPRECATED
versionID="2014-Jun-04"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
#-----------------------------------
# source/hague_flow.csv
sourceDir="source"
datafile="hague_flow.csv"
