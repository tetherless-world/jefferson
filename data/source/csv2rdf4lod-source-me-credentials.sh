...
source /etc/prizms/jefferson/triple-store/virtuoso/csv2rdf4lod-source-me-for-virtuoso-credentials.sh
source /etc/prizms/jefferson/ckan/datahub.io/csv2rdf4lod-source-me-for-ckan-credentials.sh
